...
readStatement = {-question "parse read-statement"-}
  do
    symbol "read"
    i <- identif
    symbol ";"
...
writeStatement = {-question "parse write-statement"-}
  do
    symbol "write"
    e <- expr
    symbol ";"
...
printStatement = {-question "parse print-statement"-}
  do
    symbol "print"
    s <- getString
    symbol ";"
...
keywords :: [String]
keywords = ["write", "read", "print", "if", "else", "while"] {-question "give a correct list of keywords"-}
